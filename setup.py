...
lexica = [
    "orthographic_basque.txt",
    "orthographic_dutch.txt",
    "orthographic_english.txt",
    "orthographic_french.txt",
    "orthographic_german.txt",
    "orthographic_italian.txt",
    "orthographic_polish.txt",
    "orthographic_serbian_cyrillic.txt",
    "orthographic_serbian_latin.txt",
    "orthographic_spanish.txt",
    "orthographic_turkish.txt",
    "orthographic_vietnamese.txt",
    "phonetic_english_celex.txt",
    "phonetic_english_cmu.txt",
    "phonetic_french.txt",
...
plugins = [
    "__init__.py",
    "base_plugin.py",
    "orthographic_basque.py",
    "orthographic_dutch.py",
    "orthographic_english.py",
    "orthographic_french.py",
    ...
    "orthographic_turkish.py",
    "orthographic_vietnamese.py",
    "phonetic_english_celex.py",
    "phonetic_english_cmu.py",
    "phonetic_french.py",
    "phonetic_italian.py",
    "segment.py",
    "subsyllabic_common.py",
]
